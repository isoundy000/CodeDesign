...
-- ----------------------------
-- Table structure for `t_ddz_rooms`
-- ----------------------------
DROP TABLE IF EXISTS `t_ddz_rooms`;
CREATE TABLE `t_ddz_rooms` (
  `uuid` char(20) NOT NULL,
  `id` char(8) NOT NULL,
  `base_info` varchar(256) NOT NULL DEFAULT '0',
  `create_time` int(11) NOT NULL,
...
-- ----------------------------
-- Table structure for `t_qhb_rooms`
-- ----------------------------
DROP TABLE IF EXISTS `t_qhb_rooms`;
CREATE TABLE `t_qhb_rooms` (
  `uuid` char(20) NOT NULL,
  `id` char(8) NOT NULL,
  `base_info` varchar(256) NOT NULL DEFAULT '0',
  `create_time` int(11) NOT NULL,
...
-- ----------------------------
-- Table structure for `t_mj_rooms`
-- ----------------------------
DROP TABLE IF EXISTS `t_mj_rooms`;
CREATE TABLE `t_mj_rooms` (
  `uuid` char(20) NOT NULL,
  `id` char(8) NOT NULL,
  `base_info` varchar(256) NOT NULL DEFAULT '0',
  `create_time` int(11) NOT NULL,
